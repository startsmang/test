/*
 ...
 Source Schema         : wmsdemo

 Target Server Type    : MySQL
 Target Server Version : 50636
 File Encoding         : 65001

 Date: 17/12/2021 16:36:27
*/
...
INSERT INTO `brand` VALUES (10, '44', '44');
...
INSERT INTO `department` VALUES (11, '23', '34');
INSERT INTO `department` VALUES (14, '444', '666');
INSERT INTO `department` VALUES (16, 'name_test007', 'sn_test007');
INSERT INTO `department` VALUES (17, 'name_test007', 'sn_test007');
INSERT INTO `department` VALUES (18, 'name_test007', 'sn_test007');
INSERT INTO `department` VALUES (19, '', '');
INSERT INTO `department` VALUES (20, '2323', '2323');
INSERT INTO `department` VALUES (24, 'name_dept_002', 'sn_dept_002');
INSERT INTO `department` VALUES (33, 'name_dept_001', 'sn_dept_001');
INSERT INTO `department` VALUES (34, 'name_dept_002', 'sn_dept_002');
INSERT INTO `department` VALUES (35, 'name_dept_003', 'sn_dept_003');
INSERT INTO `department` VALUES (37, 'name_dept_001', 'sn_dept_001');
INSERT INTO `department` VALUES (38, 'name_dept_002', 'sn_dept_002');
INSERT INTO `department` VALUES (39, 'name_dept_003', 'sn_dept_003');
INSERT INTO `department` VALUES (41, 'name_dept_001', 'sn_dept_001');
INSERT INTO `department` VALUES (42, 'name_dept_002', 'sn_dept_002');
INSERT INTO `department` VALUES (43, 'name_dept_003', 'sn_dept_003');
INSERT INTO `department` VALUES (45, 'name_dept_001', 'sn_dept_001');
INSERT INTO `department` VALUES (46, 'name_dept_002', 'sn_dept_002');
INSERT INTO `department` VALUES (47, 'name_dept_003', 'sn_dept_003');
INSERT INTO `department` VALUES (49, 'name_dept_001', 'sn_dept_001');
INSERT INTO `department` VALUES (50, 'name_dept_002', 'sn_dept_002');
INSERT INTO `department` VALUES (51, 'name_dept_003', 'sn_dept_003');
...
INSERT INTO `depot` VALUES (4, '1', '1');
INSERT INTO `depot` VALUES (5, '2', '2');
INSERT INTO `depot` VALUES (8, '3', '3');
...
-- Records of employee
-- ----------------------------
INSERT INTO `employee` VALUES (1, 'admin', 'C4CA4238A0B923820DCC509A6F75849B', 'admin@abc.com', 20, b'1', 7);
INSERT INTO `employee` VALUES (2, '赵总', 'C4CA4238A0B923820DCC509A6F75849B', 'xx@xx.com', 35, b'0', 1);
INSERT INTO `employee` VALUES (3, '赵一明', 'C4CA4238A0B923820DCC509A6F75849B', 'xx@xx.com', 25, b'0', 1);
INSERT INTO `employee` VALUES (4, '钱总', 'C4CA4238A0B923820DCC509A6F75849B', 'xx@xx.com', 35, b'0', 2);
INSERT INTO `employee` VALUES (5, '钱二明', 'C4CA4238A0B923820DCC509A6F75849B', 'update_123456@qq.com', 25, b'1', 1);
INSERT INTO `employee` VALUES (6, '孙总', 'C4CA4238A0B923820DCC509A6F75849B', 'xx@xx.com', 35, b'0', 3);
INSERT INTO `employee` VALUES (7, '孙三明', 'C4CA4238A0B923820DCC509A6F75849B', 'xx@xx.com', 25, b'0', 3);
INSERT INTO `employee` VALUES (8, '李总', 'C4CA4238A0B923820DCC509A6F75849B', 'xx@xx.com', 35, b'0', 4);
INSERT INTO `employee` VALUES (9, '李四明', 'C4CA4238A0B923820DCC509A6F75849B', 'xx@xx.com', 25, b'0', 4);
INSERT INTO `employee` VALUES (10, '周总', 'C4CA4238A0B923820DCC509A6F75849B', 'xx@xx.com', 35, b'0', 5);
INSERT INTO `employee` VALUES (11, '周五明', 'C4CA4238A0B923820DCC509A6F75849B', 'xx@xx.com', 25, b'0', 5);
INSERT INTO `employee` VALUES (12, '吴总', 'C4CA4238A0B923820DCC509A6F75849B', 'xx@xx.com', 35, b'0', 6);
INSERT INTO `employee` VALUES (13, '吴六明', 'C4CA4238A0B923820DCC509A6F75849B', 'xx@xx.com', 25, b'0', 6);
INSERT INTO `employee` VALUES (14, '郑总', 'C4CA4238A0B923820DCC509A6F75849B', 'xx@xx.com', 35, b'0', 7);
INSERT INTO `employee` VALUES (15, '郑七明', 'C4CA4238A0B923820DCC509A6F75849B', 'xx@xx.com', 25, b'0', 7);
INSERT INTO `employee` VALUES (16, '孙四明', 'C4CA4238A0B923820DCC509A6F75849B', 'xx@xx.com', 25, b'0', 3);
INSERT INTO `employee` VALUES (17, '孙五明', 'C4CA4238A0B923820DCC509A6F75849B', 'xx@xx.com', 25, b'0', 3);
INSERT INTO `employee` VALUES (18, '李五明', 'C4CA4238A0B923820DCC509A6F75849B', 'xx@xx.com', 25, b'0', 4);
INSERT INTO `employee` VALUES (19, '李六明', 'C4CA4238A0B923820DCC509A6F75849B', 'xx@xx.com', 25, b'0', 4);
...
CREATE TABLE `orderbill`  (
  ...
  `totalNumber` decimal(19, 2) NULL DEFAULT NULL,
...
CREATE TABLE `orderbillitem`  (
  ...
  `number` decimal(19, 2) NULL DEFAULT NULL,
...
INSERT INTO `permission` VALUES (125, '员工列表', 'com._520it.wms.web.controller.EmployeeController:list');
INSERT INTO `permission` VALUES (126, '供应商编辑', 'com._520it.wms.web.controller.SupplierController:input');
INSERT INTO `permission` VALUES (127, '部门列表', 'com._520it.wms.web.controller.DepartmentController:list');
...
CREATE TABLE `product`  (
  ...
  `brandName` varchar(40) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  PRIMARY KEY (`id`) USING BTREE,
  INDEX `FK_1td6gorl25rsvufiiive2svlx`(`brand_id`) USING BTREE,
...
INSERT INTO `product` VALUES (29, '020', '001', 100.00, 160.00, '/upload/2a281513-f6c1-4429-95a5-ed21c6c86504.bmp', '暗示法sdf', 4, '锤子');
INSERT INTO `product` VALUES (30, '34', '43', 34.00, 34.00, '/upload/74cd5d25-14c9-46a8-a8cf-08b857a454c7.bmp', '3434', 1, '苹果');
INSERT INTO `product` VALUES (31, '', '', NULL, NULL, '', '', 1, '苹果');
INSERT INTO `product` VALUES (32, '111', '111', 1.00, 2.00, '', '', 1, '苹果');
INSERT INTO `product` VALUES (33, '测试商品_001', 'test_product_001', 100.00, 200.00, '/upload/55c12772-d07e-452c-bcd6-790a1ac68309.jpg', '测试商品2', 4, '锤子');
INSERT INTO `product` VALUES (34, '测试商品_002', 'test_product_002', 150.00, 300.00, '/upload/8168caba-aa18-4626-be88-0262084a0fa0.jpg', '测试商品3', 5, '360');
INSERT INTO `product` VALUES (35, '测试商品_003', 'test_product_003', 200.00, 400.00, '/upload/3046f3f9-d3b8-4023-bf98-162b3b2eeb21.jpg', '测试商品4', 6, '菲尔可');
INSERT INTO `product` VALUES (36, '测试商品_001', 'test_product_001', 100.00, 200.00, '/upload/1832715c-628b-4d72-90a7-af33cb469e75.jpg', '测试商品2', 4, '锤子');
INSERT INTO `product` VALUES (37, '测试商品_002', 'test_product_002', 150.00, 300.00, '/upload/183753d6-afbf-4a59-891f-3546d5a642a1.jpg', '测试商品3', 5, '360');
INSERT INTO `product` VALUES (38, '测试商品_003', 'test_product_003', 200.00, 400.00, '/upload/c754fc0a-cc75-4d12-9f03-5a246a13b5b2.jpg', '测试商品4', 6, '菲尔可');
INSERT INTO `product` VALUES (39, '测试商品_001', 'test_product_001', 100.00, 200.00, '/upload/6e2e56d9-ab7d-4e4d-962f-36f6fc313442.jpg', '测试商品2', 4, '锤子');
INSERT INTO `product` VALUES (40, '测试商品_002', 'test_product_002', 150.00, 300.00, '/upload/684dc43c-c199-4460-9a85-6b4fd36c6df8.jpg', '测试商品3', 5, '360');
INSERT INTO `product` VALUES (41, '测试商品_003', 'test_product_003', 200.00, 400.00, '/upload/ac0316e0-cbc7-483a-ad8b-50e009c573ce.jpg', '测试商品4', 6, '菲尔可');
INSERT INTO `product` VALUES (42, '测试商品_001', 'test_product_001', 100.00, 200.00, '/upload/14a1d1d1-9975-4a19-b4e3-95c96b770d69.jpg', '测试商品2', 4, '锤子');
INSERT INTO `product` VALUES (43, '测试商品_002', 'test_product_002', 150.00, 300.00, '/upload/16949fb7-af5b-457f-8c0f-321b102da84c.jpg', '测试商品3', 5, '360');
INSERT INTO `product` VALUES (44, '测试商品_003', 'test_product_003', 200.00, 400.00, '/upload/0af9722c-fb6c-46e0-b453-f301c40c25c7.jpg', '测试商品4', 6, '菲尔可');
INSERT INTO `product` VALUES (45, '测试商品_001', 'test_product_001', 100.00, 200.00, '/upload/7f53d6b7-ff46-4716-8299-071e5bb0c2a8.jpg', '测试商品2', 4, '锤子');
INSERT INTO `product` VALUES (46, '测试商品_002', 'test_product_002', 150.00, 300.00, '/upload/ed1d572a-073b-4251-90e5-2201da18603d.jpg', '测试商品3', 5, '360');
INSERT INTO `product` VALUES (48, '测试商品_001', 'test_product_001', 100.00, 200.00, '/upload/d8e6fea8-b9d6-41b1-9167-63647cc0457d.jpg', '测试商品2', 4, '锤子');
INSERT INTO `product` VALUES (49, '测试商品_002', 'test_product_002', 150.00, 300.00, '/upload/76c1ff98-88ba-4c0e-922f-80967112eb98.jpg', '测试商品3', 5, '360');
INSERT INTO `product` VALUES (51, '测试商品_002', 'test_product_002', 150.00, 300.00, '/upload/8d5f60e0-b437-4d87-bf06-2f72b03038f7.jpg', '测试商品3', 5, '360');
INSERT INTO `product` VALUES (53, '测试商品_001', 'test_product_001', 100.00, 200.00, '/upload/5d99e37c-c5e0-4c15-8f52-9245a9b6e8b7.jpg', '测试商品2', 4, '锤子');
INSERT INTO `product` VALUES (54, '测试商品_002', 'test_product_002', 150.00, 300.00, '/upload/05d10b0f-3d06-44d8-b2e1-c4092a4c5e3f.jpg', '测试商品3', 5, '360');
INSERT INTO `product` VALUES (56, '测试商品_001', 'test_product_001', 100.00, 200.00, '/upload/7ec914a1-69ef-4c95-b87b-122b5b82b8fd.jpg', '测试商品2', 4, '锤子');
INSERT INTO `product` VALUES (57, '测试商品_002', 'test_product_002', 150.00, 300.00, '/upload/002f5504-bb7f-4aa2-94db-94a6879ff511.jpg', '测试商品3', 5, '360');
INSERT INTO `product` VALUES (59, '测试商品_001', 'test_product_001', 100.00, 200.00, '/upload/ac5151d9-d837-4170-8021-938e72931966.jpg', '测试商品2', 4, '锤子');
INSERT INTO `product` VALUES (60, '测试商品_002', 'test_product_002', 150.00, 300.00, '/upload/6ac01eae-14e6-4ae3-a6e8-f7d1b3e9f42e.jpg', '测试商品3', 5, '360');
INSERT INTO `product` VALUES (62, '测试商品_001', 'test_product_001', 100.00, 200.00, '/upload/8b717c95-3d6a-409b-9719-78c004c658e0.jpg', '测试商品2', 4, '锤子');
INSERT INTO `product` VALUES (63, '测试商品_002', 'test_product_002', 150.00, 300.00, '/upload/a1d39f36-41a3-4e31-ac76-8a0125e6fd9a.jpg', '测试商品3', 5, '360');
INSERT INTO `product` VALUES (65, '测试商品_001', 'test_product_001', 100.00, 200.00, '/upload/d3599695-8feb-4d92-9b38-09411b7ff832.jpg', '测试商品2', 4, '锤子');
INSERT INTO `product` VALUES (66, '测试商品_002', 'test_product_002', 150.00, 300.00, '/upload/c100ed6f-39d1-4702-acab-df577b398e45.jpg', '测试商品3', 5, '360');
INSERT INTO `product` VALUES (68, '测试商品_001', 'test_product_001', 100.00, 200.00, '/upload/2d2019fb-48eb-4825-970f-8bc2613342cb.jpg', '测试商品2', 4, '锤子');
INSERT INTO `product` VALUES (71, '测试商品_001', 'test_product_001', 100.00, 200.00, '/upload/7540e115-4e6d-48d0-970b-80b53476935e.jpg', '测试商品2', 4, '锤子');
INSERT INTO `product` VALUES (72, '测试商品_002', 'test_product_002', 150.00, 300.00, '/upload/eb36ab66-0809-4292-a2c5-1d84ce55ac96.jpg', '测试商品3', 5, '360');
...
CREATE TABLE `productstock`  (
  ...
  `storeNumber` decimal(19, 2) NULL DEFAULT NULL,
  `amount` decimal(19, 2) NULL DEFAULT NULL,
  `product_id` bigint(20) NULL DEFAULT NULL,
...
INSERT INTO `role` VALUES (11, '测试角色_001', 'test_001');
INSERT INTO `role` VALUES (12, '测试角色_001', 'test_001');
INSERT INTO `role` VALUES (13, '测试角色_001', 'test_001');
...
INSERT INTO `role_menu` VALUES (13, 5);
...
INSERT INTO `role_permission` VALUES (12, 66);
INSERT INTO `role_permission` VALUES (12, 67);
...
CREATE TABLE `saleaccount`  (
  ...
  `number` decimal(19, 2) NULL DEFAULT NULL,
  `costPrice` decimal(19, 2) NULL DEFAULT NULL,
  `costAmount` decimal(19, 2) NULL DEFAULT NULL,
  `salePrice` decimal(19, 2) NULL DEFAULT NULL,
  `saleAmount` decimal(19, 2) NULL DEFAULT NULL,
  `product_id` bigint(20) NULL DEFAULT NULL,
  `saleman_id` bigint(20) NULL DEFAULT NULL,
...
INSERT INTO `systemmenu` VALUES (20, 'a', '', 'a', NULL);
INSERT INTO `systemmenu` VALUES (21, 'f', '', 'f', 20);
INSERT INTO `systemmenu` VALUES (22, 'c', 'c', 'c', 21);
